...
import com.shopee.shopee_backend.dto.DashboardStatsDto;
import com.shopee.shopee_backend.dto.FranchiseDto;
import com.shopee.shopee_backend.dto.LowStockAlertDto;
...
public interface AdminService {
     ...
     FranchiseDto updateFranchise(Long franchiseId, UpdateFranchiseRequestDto request);

     FranchiseDto toggleFranchiseStatus(Long franchiseId, boolean active);

     UserDto updateUserStatus(Long userId, UpdateUserStatusRequestDto request);
}